...
class TileMap(context: Context, zoomLevel: Int) {
  ...
  private val YangtzeRiver7 = new River(Array(
  ...
  // 湘江
  private val XiangRiver = new River(Array(
